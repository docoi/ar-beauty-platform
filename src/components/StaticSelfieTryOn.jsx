...
const StaticSelfieTryOn = ({
  ...
  useEffect(() => {
    if (!isPreviewing && rendererRef.current && staticImageRef.current) {
        if (!isDetecting) { // Only trigger render when not actively detecting
            console.log("Render Trigger: Calling renderStaticImageResults w/ corrections.");
            rendererRef.current.renderStaticImageResults( staticImageRef.current, detectedSelfieResults, selfieBrightness, selfieContrast );
        } else {
             console.log("Render Trigger: Rendering base image while detecting.");
             // Don't pass results while detecting, DO pass correction values
             rendererRef.current.renderStaticImageResults( staticImageRef.current, null, selfieBrightness, selfieContrast );
        }
  ...
  }, [isPreviewing, isDetecting, detectedSelfieResults, selfieDimensions, selfieBrightness, selfieContrast, faceLandmarker]);
