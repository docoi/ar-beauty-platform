...
// Using the values you determined experimentally
...
const StaticSelfieTryOn = forwardRef(({
    faceLandmarker,
    effectIntensity
    // REMOVED selfieBrightness, selfieContrast props from here
}, ref) => {
  ...
  // REMOVED selfieBrightness, selfieContrast from dependencies
