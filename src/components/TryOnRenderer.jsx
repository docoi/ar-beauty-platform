// src/components/TryOnRenderer.jsx - Revert to MeshBasicMaterial (Working Visually)
...
const TryOnRenderer = forwardRef(({ videoWidth, videoHeight, className }, ref) => {
  ...
  // Removed currentResults ref as effects are deferred
  ...
  // --- Render Loop (Minimal Texture Logic for MeshBasicMaterial) ---
  const renderLoop = useCallback(() => {
       ...
       if (material.map !== textureToAssign) {
            // console.log("Minimal Loop: Updating material.map");
