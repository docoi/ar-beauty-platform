...
// Use the value you found looked best, or start with this and adjust.
const TARGET_PREVIEW_SATURATION = 0.8; // You might have preferred 0.85 or 0.9 etc.
// ---------------------------------------------
...
const TryOnRenderer = forwardRef(({
    ...
    // Keep other refs defined for consistency during init/cleanup
