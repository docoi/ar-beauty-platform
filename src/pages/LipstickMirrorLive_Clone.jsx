...
export default function LipstickMirrorLive_Clone() {
  ...
  useEffect(() => {
    ...
    const render = async () => {
        ...
        if (!currentDevice || !currentContext || !pState.lipModelPipeline || !pState.depthTextureView) { animationFrameIdRef.current = requestAnimationFrame(render); return; }
    ...
    const initializeAll = async () => {
        ...
        try {
            ...
            p.lipstickAlbedoSampler = deviceInternal.createSampler({label:"MaterialSampler", magFilter:'linear', minFilter:'linear'});
            ...
            console.log("[LML_Clone 3DModel] GPU resources initialized for static model test.");
